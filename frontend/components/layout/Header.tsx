        ...
        <div className="flex items-center gap-6">
          <Show when="signed-out">
            <SignInButton mode="modal">
              <button id="header-btn-login" className="text-sm font-bold text-on-surface-variant hover:text-primary transition-colors cursor-pointer">Log In</button>
            </SignInButton>
            <SignUpButton mode="modal">
              <button id="header-btn-get-started" className="bg-primary hover:bg-primary-container text-on-primary px-6 py-2.5 rounded-full text-sm font-bold shadow-lg shadow-primary/20 transition-all duration-300 active:scale-95 transform cursor-pointer">Get Started</button>
            </SignUpButton>
          </Show>
          <Show when="signed-in">
            <Link id="header-link-dashboard" href="/dashboard" className="text-sm font-bold text-primary hover:opacity-80 transition-opacity">
              Dashboard
            </Link>
